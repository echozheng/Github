...
--
-- Host: localhost    Database: mavenwebdemo
-- ------------------------------------------------------
...
CREATE TABLE `c_person` (
  ...
  `c_idnum` varchar(100) DEFAULT NULL,
...
INSERT INTO `c_person` VALUES (1,'zql','35032119901202****','changsha city,hunan province,China');
...
-- Dump completed on 2015-09-05 11:07:30
